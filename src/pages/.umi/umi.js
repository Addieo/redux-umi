...
import findRoute, {
  getUrlQuery,
} from '/Users/linzhijing/Desktop/我的学习/第二阶段react/课件及资料/react项目实战/lesson8-umi/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path:
        '/Users/linzhijing/Desktop/我的学习/第二阶段react/课件及资料/react项目实战/lesson8-umi',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
